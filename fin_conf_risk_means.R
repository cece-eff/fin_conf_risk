### fin_conf_risk importing, computing and means 
### CCF 5.31.24
...
#Before conducting any data analyses, we compute the following variables:
#  - `alpha`: the average of small and large magnitude time discounting measures
...
##overconfidence-- difference between confidence and financial literacy overall
rush1wave_mod %>%
